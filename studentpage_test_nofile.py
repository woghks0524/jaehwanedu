...
assistant_id = 'asst_8KPRKJxu7BsX9ZwuS3qKkgjr'
...
- 선생님이 알려주신 평가 코드를 적은 뒤 '평가 코드 확인하기' 버튼을 눌러주세요.
- 평가 코드를 입력해야 다음 단계로 넘어갈 수 있습니다.""")
                    
        st.success("""2. [정보 입력하기]:           
- 반, 번호, 이름을 적은 뒤 '학생 정보 등록하기' 버튼을 눌러주세요. 
- 정보를 입력해야 다음 단계로 넘어갈 수 있습니다.""")

        st.error("""3. [답안 작성 및 결과 확인하기]:            
- 서술형 문항을 잘 읽고 답안을 작성하세요.
- 답안을 작성한 뒤 '작성 답안 등록하기' 버튼을 눌러주세요.         
- '채점 결과 확인하기' 버튼을 누르면 내가 등록한 답안에 대한 채점 결과를 확인할 수 있습니다.    
- 소감과 느낀점을 남길 수 있습니다. 소감 및 느낀점을 적은 뒤 '소감 및 느낀점 등록하기' 버튼을 눌러주세요.          
...
def step1():
    ...
    st.info("선생님이 알려주신 평가 코드를 적은 뒤 '평가 코드 확인하기' 버튼을 눌러주세요. 평가 코드를 입력해야 다음 단계로 넘어갈 수 있습니다.")
...
# 채점 결과 생성 
    with st.container(border=True):
        st.caption("채점 결과")
        st.error("'채점 결과 확인하기' 버튼을 누르면 내가 작성한 답안에 대한 채점 결과를 확인할 수 있습니다.")
...
# 학생 의견 작성 
    with st.container(border=True):
        st.caption("소감 및 느낀점")
        st.error("채점 결과를 통해 새롭게 알게된 점이나 궁금한 점, 채점 결과에 대해 이해가 가지 않는 점 등 생각을 적어주세요.")
        studentopinion1 = st.text_area("", label_visibility="collapsed", key="textarea1")

        st.error("서술형 평가 연습 과정에 대해 선생님께 하고 싶은 말이나 좋았던 점, 아쉬웠던 점 등 전반적인 소감이나 느낀점을 적어주세요. 의견을 작성한 뒤 '소감 및 느낀점 등록하기' 버튼을 눌러주세요.")
